...
public class FragmentDisclaimer extends Fragment {
    ...
    public static FragmentDisclaimer newInstance(String param1, String param2) {
    ...
    public void onButtonPressed(Uri uri) {
        if (mListener != null) {
            mListener.onFragmentInteraction_disclaimer(uri);
        }
    }
    ...
    public interface OnFragmentInteractionListener {
        ...
        void onFragmentInteraction_disclaimer(Uri uri);
    }
}
