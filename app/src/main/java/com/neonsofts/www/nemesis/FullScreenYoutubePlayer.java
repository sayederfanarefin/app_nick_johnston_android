...
import com.neonsofts.www.nemesis.Values.DeveloperKey;
 ...
 */
public class FullScreenYoutubePlayer extends YouTubeFailureRecoveryActivity implements
 ...
 // private Button fullscreenButton;
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    videoId = b.getString("jam_video_id");
  ...
  public void onInitializationSuccess(YouTubePlayer.Provider provider, YouTubePlayer player, boolean wasRestored) {
    ...
    player.addFullscreenControlFlag(YouTubePlayer.FULLSCREEN_FLAG_ALWAYS_FULLSCREEN_IN_LANDSCAPE);//FULLSCREEN_FLAG_CUSTOM_LAYOUT);
...
/*
  private void setControlsEnabled() {
      ...
      Boolean x =  player != null && getResources().getConfiguration().orientation == Configuration.ORIENTATION_PORTRAIT;
